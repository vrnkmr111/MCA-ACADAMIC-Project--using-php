...
$sql = "SELECT id,p,q,n,d,cipher,array_cipher FROM user_ciphertext where umail='$email' and mcipher='$secret' and d='$k'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
    // output data of each row	
	echo "<table border=1 background='green.jpg'><tr><td>Cipher</td></tr><tr>";
...
?>
<form method="POST" action="laststep1.php">
<p align="center"><input type="submit" name="final" value="Generate ORIGINAL Plain Text" class="active" style="width:200px;height:35px;"></p>
</form>
<?php
...
$arr=array();
$sql = "SELECT p,q,d,array_cipher FROM user_ciphertext where umail='$email' and d='$k'";
$result = mysqli_query($conn, $sql);
