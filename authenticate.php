...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<table><tr><td>ID</td><td>N</td><td>Private Key</td><td>SECRET CIPHER</td></tr><tr>";
    while($row = mysqli_fetch_assoc($result)) {
        echo "<td> " . $row["id"]. "</td><td>".$row["n"]."<td>" . $row["d"]. "</td><td><textarea type='text' width='400px'>".$row["mcipher"]."</textarea></td></tr>";
    }
	echo"</table>";
} else {
    echo "0 results";
...
<table><tr><td>
Copy and Paste Secret Cipher Text Here:</td><td><input type="text" name="secrettext" value="" style="width:300px;height:100px;"></td></tr>
